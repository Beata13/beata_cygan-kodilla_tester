...
public class SchoolDirectory {
    public static void main(String[] args) {
        ...
        School JamesSchool = new School(200,100,400);
        School AnnSchool = new School(300,300,100);
        School JohnSchool = new School(400,200,200);
        ...
        for (Map.Entry<Principal, School> principalSchoolEntry : directors.entrySet())
            System.out.println(principalSchoolEntry.getKey().getFirstName() +
                    principalSchoolEntry.getValue().allStudents());
    }
}
